import { Brain, Sparkles, BarChart3, Settings } from 'lucide-react';
          ...
          <div className="flex items-center space-x-4">
            {isSignedIn ? (
              <div className="flex items-center space-x-4">
                ...
                {/* User Stats - Optional quick stats */}
                <div className="hidden md:flex items-center space-x-4 bg-gray-50 rounded-xl px-4 py-2 border border-gray-200">
                  <div className="flex items-center space-x-2">
...
// Optional: Export header variants for different pages
        ...
        <div className="flex items-center justify-between">
          ...
          {isSignedIn && (
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <a href="/history" className="text-gray-600 hover:text-gray-900 transition-colors">History</a>
